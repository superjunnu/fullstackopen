...
Note right of selain: Lomakkeen tietoja ei siis lähetetä normaalin lomakkeiden lähetysmekanismin (action- ja method-attribuuttien) avulla kuten perinteisemmässä versiossa
